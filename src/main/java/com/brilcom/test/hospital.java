...
public class hospital {
	/* Java 1.8 샘플 코드 */
	    ...
	    public static void main(String[] args) throws IOException {
	        ...
	        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=iHo5nIy5EdGVrbenA2NLPQtCq9hxMPRf43eYj562BJ88KH7e%2FFctARzeBmmfQWFhYWN6RMP0ROAFYu2UiNL82g%3D%3D"); /*Service Key*/
