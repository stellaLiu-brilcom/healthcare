...
public class RecordType extends HttpServlet {
	...
	private final String queryKey = "recordType";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String t_idx = (String) request.getAttribute("t_idx");

		
		String arr[] = new String[] { userid, t_idx ,"", "", "", ""};
	...
	public static void main(String[] args) {
		...
		try {
			...
			String sql = "insert into symptom (userid, t_idx, r_idx, PEFR, memo, e_regDate) value(?,?,?,?,?,?)";
