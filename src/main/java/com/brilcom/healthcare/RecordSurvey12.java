...
public class RecordSurvey12 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			try {
				int updatedCnt = remote.executeUpdate(dataSource, QUERY_FILE, "recordScore", dummy , arr);
